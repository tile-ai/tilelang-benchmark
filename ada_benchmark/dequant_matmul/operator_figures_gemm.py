...
import numpy as np
from data.data_gemm import matmul_providers as providers
from data.data_gemm import matmul_times_data as times_data
...
ax.set_ylabel("Speedup vs cuBLAS-W$_{FP16}$A$_{FP16}$", fontsize=18)
...
plt.savefig("pdf/op_benchmark_a100_wq_gemm.pdf", bbox_inches='tight')
plt.savefig("png/op_benchmark_a100_wq_gemm.png", bbox_inches='tight', dpi=255)
