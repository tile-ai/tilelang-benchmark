...
import numpy as np
from data.data_int8_gemm import matmul_times_data as times_data
from data.data_int8_gemm import matmul_providers as providers
...
# add a title
plt.title("Speedup of GEMM W$_{INT8}$A$_{INT8}$ on A100", fontsize=20)

# Save the plot to a file
plt.savefig("pdf/op_benchmark_a100_int8_gemm.pdf", bbox_inches='tight')
plt.savefig("png/op_benchmark_a100_int8_gemm.png",  bbox_inches='tight', transparent=False, dpi=255)
