...
import numpy as np
from data.a100_gemm import s4_gemv_provider as providers
from data.a100_gemm import s4_gemv_times_data as times_data
...
plt.savefig(
    f"pdf/op_benchmark_a100_wq_gemv_e{num_ops}.pdf", bbox_inches="tight"
)
plt.savefig(
    f"png/op_benchmark_a100_wq_gemv_e{num_ops}.png",
    bbox_inches="tight",
    dpi=255,
)
