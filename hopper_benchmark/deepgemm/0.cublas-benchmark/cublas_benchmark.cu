...
std::vector<std::tuple<int, int, int, bool, bool>> inference_server_set = {
    ...
    // std::make_tuple(64, 2112, 7168, false, true),
    // std::make_tuple(64, 24576, 1536, false, true),
    // std::make_tuple(64, 32768, 512, false, true),
    // std::make_tuple(64, 7168, 16384, false, true),
    // std::make_tuple(64, 4096, 7168, false, true),
    // std::make_tuple(64, 7168, 2048, false, true),
    // std::make_tuple(128, 2112, 7168, false, true),
    // std::make_tuple(128, 24576, 1536, false, true),
    // std::make_tuple(128, 32768, 512, false, true),
    // std::make_tuple(128, 7168, 16384, false, true),
    // std::make_tuple(128, 4096, 7168, false, true),
    // std::make_tuple(128, 7168, 2048, false, true),
    // std::make_tuple(4096, 4096, 4096, false, true),
    // std::make_tuple(4096, 2112, 7168, false, true),
    // std::make_tuple(4096, 24576, 1536, false, true),
    // std::make_tuple(4096, 32768, 512, false, true),
    // std::make_tuple(4096, 7168, 16384, false, true),
    // std::make_tuple(4096, 4096, 7168, false, true),
    // std::make_tuple(4096, 7168, 2048, false, true)
};
...
{
    if(is_fp_e4m3 || is_fp_e5m2) assert(a_t && !b_t);
    const int alpha = 1.f;
    const int beta = 1.f;
    ...
    CUDA_CHECK_CUBLAS(cublasLtMatrixLayoutCreate(&Adesc, A_type, A.dims()[1], A.dims()[0], A.dims()[1]));
    CUDA_CHECK_CUBLAS(cublasLtMatrixLayoutCreate(&Bdesc, B_type, B.dims()[1], B.dims()[0], B.dims()[1]));
    CUDA_CHECK_CUBLAS(cublasLtMatrixLayoutCreate(&Cdesc, C_type, m, n, m));
