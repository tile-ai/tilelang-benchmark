...
import numpy as np
from data.data_int8_gemv import matmul_times_data as times_data
from data.data_int8_gemv import matmul_providers as providers
...
_1x_baseline = "cuBLAS-W$_{INT8}$A$_{INT8}$"
...
ax.axhline(y=1, color="black", linestyle="dashed", label="cuBLAS-W$_{INT8}$A$_{INT8}$")
...
ax.set_ylabel("Speedup vs cuBLAS-W$_{INT8}$A$_{INT8}$", fontsize=20)
...
# add a title
plt.title("Speedup of GEMV W$_{INT8}$A$_{INT8}$ on A100", fontsize=20)

# Save the plot to a file
plt.savefig("pdf/op_benchmark_a100_int8_gemv.pdf", bbox_inches='tight')
plt.savefig("png/op_benchmark_a100_int8_gemv.png",  bbox_inches='tight', transparent=False, dpi=255)
